...
See business_plan.MD (Data Structure, Account Creation & Security) for the
domain/security rules this configuration exists to enforce.
"""
...
WSGI_APPLICATION = "mellax.wsgi.application"
